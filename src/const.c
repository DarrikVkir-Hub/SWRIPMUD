...
const flag_name obj_flag_table[] =
{
    ...
    { ITEM_HUM, "Hum"},
    { ITEM_DARK, "Dark"},
    { ITEM_HUTT_SIZE, "HuttSize"},
    { ITEM_CONTRABAND, "Contraband"},
    { ITEM_INVIS, "Invis"},
    { ITEM_MAGIC, "Magic"},
    { ITEM_NODROP, "NoDrop"},
    { ITEM_BLESS, "Bless"},
    ...
    { ITEM_ANTI_SOLDIER, "AntiSoldier"},
    { ITEM_TWO_HANDS, "TwoHands"},
    { ITEM_ANTI_HUNTER, "AntiHunter"},
    { ITEM_ANTI_JEDI, "AntiJedi"},
    { ITEM_SMALL_SIZE, "SmallSize"},
    { ITEM_LARGE_SIZE, "LargeSize"},
    { ITEM_DONATION, "Donation"},
    { ITEM_CLANOBJECT, "ClanObject"},
    { ITEM_ANTI_CITIZEN, "AntiCitizen"},
    { ITEM_ANTI_SITH, "AntiSith"},
    { ITEM_ANTI_PILOT, "AntiPilot"},
    { ITEM_HIDDEN, "Hidden"},
    { ITEM_POISONED, "Poisoned"},
    { ITEM_COVERING, "Covering"},
    { ITEM_DEATHROT, "Deathrot"},
    { ITEM_BURRIED, "Buried"},
    { ITEM_PROTOTYPE, "Prototype"},
    { ITEM_HUMAN_SIZE, "HumanSize"},
    { ITEM_RETURNING, "Returning"},
    { ITEM_BACKSTABBER, "Backstabber"},
    { ITEM_BANE, "Bane"},
    { ITEM_LOYAL, "Loyal"},
    { ITEM_HASTE, "Haste"},
    { ITEM_DRAIN, "Drain"},
    { ITEM_LIGHTNING_BLADE, "LightningBlade"},
    { ITEM_MAX, "Item_Max"},

    { (size_t)-1, nullptr } // terminator
};

const flag_name command_groups[] =
{
    { CGROUP_IMPLEMENTOR,  "[Implementor]" },
    { CGROUP_CODER,        "[Coder]" },
    { CGROUP_HEAD_BUILDER, "[Head Builder]" },
    { CGROUP_BUILDER,      "[Builder]" },
    { CGROUP_SHIP_BUILDER, "[Ship Builder]" },
    { CGROUP_HEAD_CLAN,    "[Head Clan]" },
    { CGROUP_CLAN_PATRON,  "[Clan Patron]" },
    { CGROUP_HEAD_ADMIN,   "[Head Administrator]" },
    { CGROUP_ADMIN,        "[Administrator]" },
    { CGROUP_QUEST_MASTER, "[Quest Master]" },
    { MAX_COMMAND_GROUP,   "CGROUP_MAX"},
    { (size_t)-1, nullptr } // terminator
};

const flag_name npc_race[] =
{
    { RACE_HUMAN,               "Human" },
    { RACE_WOOKIEE,             "Wookiee" },
    { RACE_TWI_LEK,             "Twi'lek" },
    { RACE_RODIAN,              "Rodian" },
    { RACE_HUTT,                "Hutt" },
    { RACE_MON_CALAMARI,        "Mon Calamari" },
    { RACE_SHISTAVANEN,         "Shistavanen" },
    { RACE_GAMORREAN,           "Gamorrean" },
    { RACE_JAWA,                "Jawa" },
    { RACE_ADARIAN,             "Adarian" },
    { RACE_EWOK,                "Ewok" },
    { RACE_VERPINE,             "Verpine" },
    { RACE_DEFEL,               "Defel" },
    { RACE_TRANDOSHAN,          "Trandoshan" },
    { RACE_CHADRA_FAN,          "Chadra-Fan" },
    { RACE_QUARREN,             "Quarren" },
    { RACE_SULLUSTAN,           "Sullustan" },
    { RACE_FALLEEN,             "Falleen" },
    { RACE_ITHORIAN,            "Ithorian" },
    { RACE_DEVARONIAN,          "Devaronian" },
    { RACE_GOTAL,               "Gotal" },
    { RACE_DROID,               "Droid" },
    { RACE_FIRRERREO,           "Firrerreo" },
    { RACE_BARABEL,             "Barabel" },
    { RACE_BOTHAN,              "Bothan" },
    { RACE_TOGARIAN,            "Togorian" },
    { RACE_DUG,                 "Dug" },
    { RACE_KUBAZ,               "Kubaz" },
    { RACE_SELONIAN,            "Selonian" },
    { RACE_GRAN,                "Gran" },
    { RACE_YEVETHA,             "Yevetha" },
    { RACE_GAND,                "Gand" },
    { RACE_DUROS,               "Duros" },
    { RACE_COYNITE,             "Coynite" },
    { RACE_PROTOCAL_DROID,      "Protocal Droid" },
    { RACE_ASSASSIN_DROID,      "Assassin Droid" },
    { RACE_GLADIATOR_DROID,     "Gladiator Droid" },
    { RACE_ASTROMECH_DROID,     "Astromech" },
    { RACE_INTERROGATION_DROID, "Interrogation Droid" },
    { RACE_GOD,                 "God" },
    { RACE_NOGHRI,              "Noghri" },
